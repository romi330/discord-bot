...
class HelpView(discord.ui.View):
    ...
    async def general_button(
        ...
        embed.add_field(
            name="`/test`", value="Check if the bot is working", inline=False
        )
        embed.add_field(
            name="`/invite`", value="Get the bot's invite link", inline=False
        )
        embed.add_field(
            name="`/paul`", value="View changelog and bot information", inline=False
        )
        embed.add_field(
            name="`/source`", value="View the bot's source code", inline=False
        )
        embed.add_field(
        ...
        embed.add_field(
            name="`/feedback`", value="Send feedback to the developer", inline=False
        )
    ...
    async def fun_button(self, interaction: discord.Interaction, _: discord.ui.Button):
        ...
        embed.add_field(
            name="`/dadjoke`", value="Tells a random dad joke", inline=False
        )
        embed.add_field(
            name="`/pfp`",
            value="Get your or someone else's profile picture",
            inline=False,
        )
        embed.add_field(
    ...
    async def moderation_button(
        ...
        embed.add_field(
            name="`/purge`", value="Purge messages in a channel", inline=False
        )
        embed.add_field(
            name="`/timeout`", value="Timeout a user for a set duration", inline=False
        )
        embed.add_field(
            name="`/announce`", value="Announce a message in a channel", inline=False
        )
    ...
    async def automoderation_button(
        self, interaction: discord.Interaction, _: discord.ui.Button
    ):
        embed = discord.Embed(
        ...
        features = [
            (
                "🚫 Blocked Words",
                "Block specific words that will be automatically deleted",
            ),
            ("🔗 Link Blocker", "Prevent links from being posted in chat"),
            (
                "🔄 Spam Detection",
                "Detect and prevent message spam based on similarity and frequency",
            ),
...
class HelpCommand(commands.Cog):
    ...
    @app_commands.command(
        name="help", description="Get information about the bot and available commands."
    )
    async def help_command(self, interaction: discord.Interaction):
        ...
        embed.add_field(
            ...
            value="This bot offers moderation, fun commands, and automod features.",
            inline=False,
        )
        embed.add_field(
            name="Need more help?",
            value="Join our [support server](https://discord.gg/8hYZUtUxme) for assistance.",
            inline=False,
        )
