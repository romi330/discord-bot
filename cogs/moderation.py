...
class Moderation(commands.Cog):
    ...
    async def kick(self, interaction: discord.Interaction, member: discord.Member):
        try:
            ...
            await interaction.response.send_message(
                f"Kicked `{member.display_name}` - `{member.id}`.", ephemeral=True
            )
    ...
    async def ban(self, interaction: discord.Interaction, member: discord.Member):
        try:
            ...
            await interaction.response.send_message(
                f"Banned `{member.display_name}` - `{member.id}`.", ephemeral=True
            )
        except discord.Forbidden:
            embed = discord.Embed(
    ...
    async def timeout(
        ...
        try:
            ...
            await interaction.response.send_message(
                f"{member.mention} was timed out for {duration}.", ephemeral=True
            )
        except discord.Forbidden:
            embed = discord.Embed(
    ...
    async def announce(
        ...
        try:
            ...
            embed.set_footer(
                text=f"This announcement was made by {interaction.user.name}."
            )
            if role:
                mention = (
                    "@everyone"
            ...
            await interaction.response.send_message(
                f"Announced `{message}` in {channel}.", ephemeral=True
            )
        except discord.Forbidden:
            embed = discord.Embed(
    ...
    async def lock(
        ...
        try:
            ...
            await interaction.response.send_message(
                f"{channel.mention} was locked.", ephemeral=True
            )
    ...
    async def unlock(
        ...
        try:
            ...
            await interaction.response.send_message(
                f"{channel.mention} was unlocked.", ephemeral=True
            )
